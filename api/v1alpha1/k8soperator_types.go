...
type K8soperatorStatus struct {
	...
	// conditions represent the current state of the K8soperator resource.
...
type K8soperator struct {
	...
	// spec defines the desired state of K8soperator
	// +required
	Spec K8soperatorSpec `json:"spec"`

	// status defines the observed state of K8soperator
	// +optional
	Status K8soperatorStatus `json:"status,omitempty,omitzero"`
}
