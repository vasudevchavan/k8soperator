...
import (
	...
	"github.com/vasudevchavan/k8soperator/internal/controller"
...
func main() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "c2da409a.mydomain.com",
	...
	if err := (&controller.K8soperatorReconciler{
		Client: mgr.GetClient(),
		Scheme: mgr.GetScheme(),
	}).SetupWithManager(mgr); err != nil {
		setupLog.Error(err, "unable to create controller", "controller", "K8soperator")
		os.Exit(1)
	}
